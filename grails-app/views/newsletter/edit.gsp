...
<html>
	...
	<body>
		<a href="#edit-newsletter" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-newsletter" class="content scaffold-edit" role="main">
			...
			<g:form url="[resource:newsletterInstance, action:'update']" method="PUT" >
