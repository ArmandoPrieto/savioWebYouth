	...
	<body>
		...
		<div id="show-newsletter" class="content scaffold-show" role="main">
			...
			<ol class="property-list newsletter">
				...
				<g:if test="${newsletterInstance?.email}">
				<li class="fieldcontain">
					<span id="email-label" class="property-label"><g:message code="newsletter.email.label" default="Email" /></span>
					
						<span class="property-value" aria-labelledby="email-label"><g:fieldValue bean="${newsletterInstance}" field="email"/></span>
