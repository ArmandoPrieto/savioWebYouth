...
<html>
	...
	<body>
		<a href="#create-newsletter" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="create-newsletter" class="content scaffold-create" role="main">
			...
			<g:form url="[resource:newsletterInstance, action:'save']" >
				<fieldset class="form">
